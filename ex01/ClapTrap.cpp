...
/*   Updated: 2022/06/07 14:49:57 by ljoffo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap default constructor without name called with 10 hit points and 10 ernergy points." << std::endl;
}

ClapTrap::ClapTrap(std::string name): _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << _name << " ClapTrap constructor called with 10 hit points and 10 ernergy points." << std::endl;
}
...
void ClapTrap::attack(const std::string& target)
{
	if (_energyPoints > 0 && _hitPoints > 0)
	{
		...
		std::cout << "To attack, " << _name << " ClapTrap used 1 ernergy point and now has " << _energyPoints << " energy points left." << std::endl;
	}
	else
		std::cout << "Sorry, " << _name << " ClapTrap doesn't have enough points or energy to attack." << std::endl;
}
